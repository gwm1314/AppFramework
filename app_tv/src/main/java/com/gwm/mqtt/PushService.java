 ...
 * 设置通知的Intent：setClazz();
 * 启动服务：PushService.actionStart(getApplicationContext());
 * 取消服务：PushService.actionStop(getApplicationContext());
 */
public class PushService extends Service
{
    ...
    private Class clazz;
	public void setClazz(Class<Activity> clazz){
        this.clazz = clazz;
    }
	@Override
